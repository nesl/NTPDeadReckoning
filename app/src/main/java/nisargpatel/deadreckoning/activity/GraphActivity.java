...
import nisargpatel.deadreckoning.ntpclasses.GoodClock;
...
public class GraphActivity extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    private static final String[] DATA_FILE_HEADINGS = {
            ...
            "Gravity" + "\n" + "t;gx;gy;gz",
            "XY_Data_Set" + "\n" + "timeStamp;originalPointX;originalPointY;rotatedPointX;rotatedPointY;weekGPS;secGPS;t;strideLength;magHeading;gyroHeading;"
    };
...
//            Log.d("mag_values", Arrays.toString(event.values));
        ...
        if (isRunning && goodClock.SntpSuceeded) {
            if (event.sensor.getType() == Sensor.TYPE_GRAVITY) {
